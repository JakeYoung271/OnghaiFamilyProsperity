...
# Data model classes. It looks like a lot of this stuff is boiler plate from previous year's competitions
...
# They mention this in the wiki but don't explain when it is necessary. Probably something like an ETF arb in later rounds
...
# similarly unclear what this is for yet
class Observation:
